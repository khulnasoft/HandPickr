...
css: Tailwind
deployUrl: https://vercel.com/new/clone?repository-url=https://github.com/khulnasoft/examples/tree/main/solutions/script-component-strategies&project-name=script-component-strategies&repository-name=script-component-strategies
...
[![Deploy with Khulnasoft](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/khulnasoft/examples/tree/main/solutions/script-component-strategies&project-name=script-component-strategies&repository-name=script-component-strategies)
...
```bash
pnpm create next-app --example https://github.com/khulnasoft/examples/tree/main/solutions/script-component-strategies script-component-strategies
```
