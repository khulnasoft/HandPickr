...
css: Tailwind
deployUrl: https://vercel.com/new/clone?repository-url=https://github.com/khulnasoft/examples/tree/main/solutions/script-component-ad&project-name=script-component-ad&repository-name=script-component-ad
...
[![Deploy with Khulnasoft](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/khulnasoft/examples/tree/main/solutions/script-component-ad&project-name=script-component-ad&repository-name=script-component-ad)
...
```bash
pnpm create next-app --example https://github.com/khulnasoft/examples/tree/main/solutions/script-component-ad
```
