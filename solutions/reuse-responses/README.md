...
css: Tailwind
deployUrl: https://vercel.com/new/clone?repository-url=https://github.com/khulnasoft/examples/tree/main/solutions/reuse-responses&project-name=reuse-responses&repository-name=reuse-responses
...
[![Deploy with Khulnasoft](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/khulnasoft/examples/tree/main/solutions/reuse-responses&project-name=reuse-responses&repository-name=reuse-responses)
...
```bash
pnpm create next-app --example https://github.com/khulnasoft/examples/tree/main/solutions/reuse-responses reuse-responses
```
