...
css: Tailwind
deployUrl: https://vercel.com/new/clone?repository-url=https://github.com/khulnasoft/examples/tree/main/solutions/loading-web-fonts&project-name=loading-web-fonts&repository-name=loading-web-fonts
...
[![Deploy with Khulnasoft](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/khulnasoft/examples/tree/main/solutions/loading-web-fonts&project-name=loading-web-fonts&repository-name=loading-web-fonts)
...
```bash
pnpm create next-app --example https://github.com/khulnasoft/examples/tree/main/solutions/loading-web-fonts
```
