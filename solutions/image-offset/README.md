...
css: Tailwind
deployUrl: https://vercel.com/new/clone?repository-url=https://github.com/khulnasoft/examples/tree/main/solutions/image-offset&project-name=image-offset&repository-name=image-offset
...
[![Deploy with Khulnasoft](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/khulnasoft/examples/tree/main/solutions/image-offset&project-name=image-offset&repository-name=image-offset)
...
```bash
pnpm create next-app --example https://github.com/khulnasoft/examples/tree/main/solutions/image-offset image-offset
```
