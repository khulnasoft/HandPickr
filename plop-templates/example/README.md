...
[![Deploy with Khulnasoft](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/khulnasoft/examples/tree/main/-- PLOP PATH HERE --&project-name=-- PLOP EXAMPLE NAME HERE --&repository-name=-- PLOP EXAMPLE NAME HERE --)
...
```bash
pnpm create next-app --example https://github.com/khulnasoft/examples/tree/main/-- PLOP PATH HERE --
```
