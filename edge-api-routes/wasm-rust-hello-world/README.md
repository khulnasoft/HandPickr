...
Build your API with Rust and WebAssembly using Khulnasoft Edge Functions.

This example uses a simple Rust "hello world" example as an API route for Khulnasoft Edge Functions.
...
[![Deploy with Khulnasoft](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https://github.com/khulnasoft/examples/tree/main/edge-api-routes/wasm-rust-hello-world&project-name=wasm-edge-api-route&repository-name=wasm-edge-api-route)
