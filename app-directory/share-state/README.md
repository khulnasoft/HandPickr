...
[![Deploy with Khulnasoft](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/khulnasoft/examples/tree/main/app-directory/share-state&project-name=share-state&repository-name=share-state)
...
```bash
pnpm create next-app --example https://github.com/khulnasoft/examples/tree/main/app-directory/share-state
```
