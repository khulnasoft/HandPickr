...
This examples shows how to use streams in [Khulnasoft Edge Functions](https://vercel.com/docs/concepts/functions/edge-functions) using the edge runtime in Next.js.
...
[![Deploy with Khulnasoft](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/khulnasoft/examples/tree/main/edge-functions/streams&project-name=edge-streams&repository-name=edge-streams)
