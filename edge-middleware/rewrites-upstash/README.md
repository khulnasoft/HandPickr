...
[![Deploy with Khulnasoft](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/khulnasoft/examples/tree/main/edge-middleware/rewrites-upstash&project-name=rewrites-upstash&repository-name=rewrites-upstash)
